...
rm ./times/fastani_gtdb_log.txt
time (for file in ./fastani_gtdb_files/*; do
    fastANI -q ./data/e.coli-K12.fasta --rl $file -t $threads 2>> ./times/fastani_gtdb_log.txt
done) 2> ./times/fastani_gtdb.time
#
##d3
